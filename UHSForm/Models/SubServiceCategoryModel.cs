...
{
    public class SubServiceCategoryModel
    {
    ...
    public class GetSubServiceCategoryModel
    {
        public string Name { get; set; }
    ...
    public class UpdateSubServiceCategoryModel
    {
        public string Name { get; set; }
        public Nullable<int> servcatID { get; set; }
        public Nullable<int> servsubcatID { get; set; }
    ...
    public class DeleteSubServiceCategoryModel { 
