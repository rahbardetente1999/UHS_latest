...
var Emitter = (function () {
    ...
    Dropzone = (function () {
        function C(e, t) {
            ...
            if (n.element.dropzone) this.element.dropzone;
                        ...
                        value: function () {
                            ...
                            if (
                                ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"),
                                    ...
                                    this.element.appendChild(C.createElement('<div class="dz-default dz-message"><i class="ik ik-file-plus" style="font-size: 24px;color: #009ef7!important;"></i><div class="ms-4"><h4 class= "fs-5 fw-bolder text-gray-900 mb-1" > Drop files here or click to upload.</h4><span class="fs-7 fw-bold text-primary opacity-75">Upload up to 5 files</span></div >')),
